...
const Footer = () => {
  return (
    <div><footer className="text-gray-600 body-font bg-slate-100">
        ...
        <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
          <div className="lg:w-1/4 md:w-1/2 w-full px-4">
            ...
            <nav className="list-none mb-10">
              ...
              <li>
              <Link href={'/hoddies'} className="text-gray-600 hover:text-gray-800">Hoodies</Link>
              </li>
              <li>
          ...
          <div className="lg:w-1/4 md:w-1/2 w-full px-4">
            ...
            <nav className="list-none mb-10">
              <li>
                <a className="text-gray-600 hover:text-gray-800">Privacy Poilcy</a>
              </li>
              <li>
          ...
          <nav className="list-none mb-10">
            <Image src={"/pay.png"} width={200} height={100} alt={''}></Image>
          </nav>
        </div> */}
        </div>
      </div>
