...
const Post = ({addToCard,products,variants}) => {
  ...
  <div className="container px-5 py-16 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto px-24 object-cover object-top rounded" src="https://m.media-amazon.com/images/I/6166TP+9sxL._UY741_.jpg"/>
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        <h2 className="text-sm title-font text-gray-500 tracking-widest">CODEWEAR</h2>
        <h1 className="text-gray-900 text-3xl title-font font-medium mb-1">Wear the Code(Yellow XL)</h1>
