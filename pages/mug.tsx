    ...
    <div><section className="text-gray-600 body-font">
      <div className="container px-5 py-24 mx-auto">
        <div className="flex flex-wrap -m-4 justify-center ">
          {Object.keys(products).length === 0 && <p>Sorry all the Mugs are currently out of stock!! New Stock coming soon! Please Stay Turn!</p>}
            ...
            return <div passHref={true} key={products[item]._it} className="lg:w-1/4 md:w-1/2 p-8 w-full shadow-lg m-2">
              ...
              <div className="mt-4 text-center md:text-left">
                ...
                <div className='mt-1'>
                  ...
                  {products[item].size.includes('PREMIUM') && <span className='border border-gray-300 px-1 mx-1'>PREMIUM,</span>}    
                  </div>
                  <div className='mt-1'>
