...
const Chechout = ({ card, addToCard, removeFromCard, subTotal }) => {
  const initiatePayment = async () => {
    ...
    const data = { card, subTotal, oid, email: "email" };
    ...
    return (
      <div className='container px-2 sm:m-auto'>
        ...
        <div className="m-4">
          <Link href={'/chechout'}><button onClick={initiatePayment} className="flex   mr-2 text-white bg-pink-500 border-0 py-2 px-2 
