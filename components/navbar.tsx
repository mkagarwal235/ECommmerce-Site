        ...
        <div className="flex flex-col md:flex-row md:justify-start justify-center items-center py-2 mb-1 shadow-md sticky top-0 bg-white z-10">
            ...
            <div className="nav">
                <ul className='flex items-center space-x-6 font-bold md:text-md'>
                    ...
                    <Link href={"/hoddies"}><li>Hoodies</li></Link>
            ...
            <div ref={ref} className={`w-72 h-[100vh] sideCard absolute top-0 right-0 bg-pink-100 py-10 px-8 transform transition-transform ${Object.keys(card).length !== 0 ? 'translate-x-0' : 'translate-x-full'}`}>
                    ...
                    {Object.keys(card).map((k) => {
                        return <li key={k}>
                            <div className="item flex my-5">
                                ...
                                <div className='w-2/3 font-semibold'>{card[k].name}</div>
